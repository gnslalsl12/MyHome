...
<body>
  <div class="header">
    <nav class="navbar" style="background-color: skyblue;">
      <div class="container">
        <div style="padding-left: 80%;"> 
          <button type="button" onclick="location.href='./sign_up.jsp'" class="btn btn-primary" id="prelogin1">회원가입</button>
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#loginModal" id="prelogin2">로그인</button>
          <button type="button" onclick="location.href='./sign_up.jsp'" class="btn btn-primary" id="login1" style="display: none;">회원정보</button>
            ...
            <form class="form-floating mb-3" action="#" id="loginForm">
              ...
              <div class="form-floating">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" onclick="location.href='./index.jsp'" id="b-login">로그인</button>
                </div>
              </div>
            </form>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
          <a class="navbar-brand" href="/index.jsp"><img src="./img/aaaa.jpg" alt="" width="150" height="150"></a>
  ...
  <div class="container" style="margin-bottom: 60px; margin-top: 40px;">
    <form class="row g-3" action="${root}/main">
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control" id="inputAddress" placeholder="김싸피" name="name">
      </div>
      <div class="col-12">
