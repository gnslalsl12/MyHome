...
<body>
  ...
  <div class="header">
    <nav class="navbar" style="background-color: skyblue;">
      <div class="container">
        ...
        <c:if test="${empty loginUser }">
          <button type="button" onclick="location.href='./sign_up.jsp'" id="prelogin1" class="btn btn-primary">회원가입</button>
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" id="prelogin2" data-bs-target="#loginModal">로그인</button>
        </c:if>
        <c:if test="${!empty loginUser}">
          <button type="button" onclick="location.href='./info.jsp'" class="btn btn-primary" id="login1">회원정보</button>
          <button type="button" onclick="location.href='${root}/main?action=logout'" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#loginModal" id="login2" name='logout'>로그아웃</button>
        </c:if>
        </div>
      </div>
    </nav>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-floating mb-3" action="${root}/main" id="loginForm" method='post'>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
          <a class="navbar-brand" href="${root}/index.jsp"><img src="./img/aaaa.jpg" alt="" width="150" height="150"></a>
