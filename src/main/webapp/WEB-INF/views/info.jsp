<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <div class="container" style="margin-bottom: 60px; margin-top: 40px;">
    <form class="row g-3" id='formId' method='post' action='${root }/user/update'>
      <div class="col-md-12">
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control" id="inputAddress" name='name' value="${loginUser.user_name}">
      </div>
      ...
      <div class="col-12">
        ...
        <button type="button" id='delete' onclick="location.href='${root}/user/delete'"  class="btn btn-primary">회원탈퇴</button>
      </div>
    </form>
  </div>
