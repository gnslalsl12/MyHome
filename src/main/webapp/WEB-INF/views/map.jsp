...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top">
      <div class="container">
        <a class="navbar-brand text-primary fw-bold" href="./index">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="aptlist.jsp">아파트매매정보</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="hospital.jsp">호흡진료지정병원</a>
            </li>
          </ul>
          <!-- 로그인 전 -->
    ...
    <div class="container">
      ...
      <script
        ...
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=57dd21f3fc158412d95faecd7bab8cf2"
      ></script>
